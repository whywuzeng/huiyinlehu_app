...
public class AsyncHttpClient {
	...
	/**
	 * Sets the connection and socket time oout. By default, 10 seconds
	 * 
	 * @param timeout
	 *            the connect and socket timeout in milliseconds
	 */
	...
	/**
	 * Sets the socket time oout. By default, 10 seconds
	 * 
	 * @param timeout
	...
	protected List<BasicNameValuePair> getParamsList(
			LinkedHashMap<String, Object> urlParams) {
		List<BasicNameValuePair> lparams = new LinkedList<BasicNameValuePair>();

		for (Entry<String, Object> entry : urlParams.entrySet()) {
			lparams.add(new BasicNameValuePair(entry.getKey(), (String) entry
					.getValue()));
		}
		return lparams;
	}
