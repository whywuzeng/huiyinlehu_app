...
public abstract class PagerAdapter {
	 ...
	 * position has changed. Returns {@link #POSITION_UNCHANGED} if the
	 * position of the given item has not changed or {@link #POSITION_NONE}
	 * if the item is no longer present in the adapter.
	 * 
	 * <p>
	 * The default implementation assumes that items will never change
	 * position and always returns {@link #POSITION_UNCHANGED}.
	 * 
	 * @param object
	 *                Object representing an item, previously returned by a
	 *                call to {@link #instantiateItem(View, int)}.
	...
	/**
	 * This method should be called by the application if the data backing
	 * this adapter has changed and associated views should update.
	 */
