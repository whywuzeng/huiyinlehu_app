...
public class PullToRefreshView extends LinearLayout {
	...
	private void addHeaderView() {
		...
		mHeaderTextView = (TextView) mHeaderView
				.findViewById(R.id.pull_to_refresh_header_hint_textview);
		...
		mHeaderProgressBar = (ProgressBar) mHeaderView
				.findViewById(R.id.pull_to_refresh_header_progressbar);
		// header layout
	...
	private void addFooterView() {
		// footer view
		mFooterView = mInflater.inflate(R.layout.pull_to_load_footer, this, false);
...
//		Log.i("", "----------------------初始化完毕.............");
	...
	private void footerRefreshing() {
		...
		mFooterTextView.setText(R.string.xlistview_header_last_time);
