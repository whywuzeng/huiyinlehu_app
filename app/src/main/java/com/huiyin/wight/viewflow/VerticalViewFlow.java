...
public class VerticalViewFlow extends AdapterView<Adapter> {
	...
	private VerticalFlowIndicator mIndicator;
	...
	public VerticalViewFlow(Context context) {
		super(context);
		mSideBuffer = 3;
		init();
	}

	public VerticalViewFlow(Context context, int sideBuffer) {
		super(context);
	...
	public VerticalViewFlow(Context context, AttributeSet attrs) {
		super(context, attrs);
	 ...
	 * @param flowIndicator
	 */
	public void setFlowIndicator(VerticalFlowIndicator flowIndicator) {
