...
public class GoodsDetailSpecValue2Adapter extends CustomAdapter {

	private ArrayList<Value2> specValueList;
	...
	public GoodsDetailSpecValue2Adapter(Context context,
			ArrayList<Value2> specValueList) {
	...
	public View getView(final int position, View contentView, ViewGroup parent) {
		...
		Value2 bean = specValueList.get(position);
